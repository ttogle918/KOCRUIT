...
from app.models.application import Application, ApplyStatus, DocumentStatus, ApplicationViewAction
...
class ApplicationBase(BaseModel):
    ...
    document_status: DocumentStatus = DocumentStatus.DOCUMENT_WAITING
