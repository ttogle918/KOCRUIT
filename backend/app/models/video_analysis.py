...
class VideoAnalysis(Base):
    ...
    # 관계 설정
    application = relationship("Application", back_populates="video_analyses")
    
    def __repr__(self):
        return f"<VideoAnalysis(id={self.id}, application_id={self.application_id}, score={self.overall_score})>"
