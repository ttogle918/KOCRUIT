        ...
        "executive_evaluations": [
            {
                ...
                "total_score": 88.5,
                "summary": "김선희 지원자는 리더십과 전략적 사고에서 매우 우수한 역량을 보여주었습니다. 팀 관리 경험과 문제해결 능력이 뛰어나며, 조직의 비전을 명확하게 제시할 수 있는 능력을 갖추고 있습니다. 임원진으로서 조직을 이끌어갈 수 있는 충분한 역량을 보유하고 있습니다.",
                "created_at": "2024-01-20T10:00:00Z",
                "updated_at": "2024-01-20T10:00:00Z",
                "status": "SUBMITTED",
                "evaluation_items": [
                    {"evaluate_type": "리더십", "evaluate_score": 92.0, "grade": "A+", "comment": "팀 관리 경험이 풍부하고 갈등 해결 능력이 뛰어남."},
                    {"evaluate_type": "전략적 사고", "evaluate_score": 90.0, "grade": "A+", "comment": "장기적 관점에서 비즈니스 전략을 수립할 수 있는 능력을 보유."},
                    {"evaluate_type": "조직 적응력", "evaluate_score": 85.0, "grade": "A", "comment": "새로운 환경에 빠르게 적응하고 기여할 수 있는 능력을 보유."},
                    {"evaluate_type": "비전 제시", "evaluate_score": 88.0, "grade": "A", "comment": "명확하고 구체적인 비전을 제시할 수 있는 능력이 있음."},
                    {"evaluate_type": "의사결정 능력", "evaluate_score": 87.0, "grade": "A", "comment": "복잡한 상황에서도 신속하고 정확한 의사결정을 할 수 있는 능력을 보유."},
                    {"evaluate_type": "인성 및 가치관", "evaluate_score": 89.0, "grade": "A", "comment": "올바른 가치관과 윤리의식을 바탕으로 한 인성을 보유."}
                ]
            },
            {
                "interview_id": 47,
                ...
                "evaluation_type": "EXECUTIVE",
                "total_score": 82.3,
                "summary": "홍길동62 지원자는 전략적 사고와 의사결정 능력에서 우수한 역량을 보여주었습니다. 시장 변화에 대한 이해도가 높고, 체계적인 접근 방식을 가지고 있습니다. 전반적으로 임원진으로서의 기본 역량은 갖추고 있습니다.",
                "created_at": "2024-01-20T11:00:00Z",
                "updated_at": "2024-01-20T11:00:00Z",
                "status": "SUBMITTED",
                "evaluation_items": [
                    {"evaluate_type": "리더십", "evaluate_score": 78.0, "grade": "B+", "comment": "기본적인 리더십 역량은 보유하고 있으나, 팀 관리 경험이 다소 부족함."},
                    {"evaluate_type": "전략적 사고", "evaluate_score": 88.0, "grade": "A", "comment": "전략적 사고 능력이 뛰어나며, 시장 변화에 대한 이해도가 높음."},
                    {"evaluate_type": "조직 적응력", "evaluate_score": 80.0, "grade": "B+", "comment": "조직 적응력은 양호하나, 더욱 적극적인 기여가 필요함."},
                    {"evaluate_type": "비전 제시", "evaluate_score": 85.0, "grade": "A", "comment": "비전 제시 능력이 우수하며, 명확한 방향성을 제시할 수 있음."},
                    {"evaluate_type": "의사결정 능력", "evaluate_score": 86.0, "grade": "A", "comment": "의사결정 능력이 뛰어나며, 복잡한 상황에서도 체계적으로 접근함."},
                    {"evaluate_type": "인성 및 가치관", "evaluate_score": 83.0, "grade": "A", "comment": "올바른 가치관을 보유하고 있으며, 윤리적 판단 능력이 우수함."}
                ]
            },
            {
                "interview_id": 60,
                ...
                "evaluation_type": "EXECUTIVE",
                "total_score": 85.7,
                "summary": "홍길동60 지원자는 조직 적응력과 비전 제시 능력에서 매우 우수한 역량을 보여주었습니다. 새로운 환경에 빠르게 적응하고 기여할 수 있는 능력이 뛰어나며, 팀원들과의 소통 능력이 우수합니다. 임원진으로서 조직을 성공적으로 이끌어갈 수 있는 역량을 갖추고 있습니다.",
                "created_at": "2024-01-20T12:00:00Z",
                "updated_at": "2024-01-20T12:00:00Z",
                "status": "SUBMITTED",
                "evaluation_items": [
                    {"evaluate_type": "리더십", "evaluate_score": 84.0, "grade": "A", "comment": "리더십 역량이 우수하며, 팀원들과의 소통 능력이 뛰어남."},
                    {"evaluate_type": "전략적 사고", "evaluate_score": 83.0, "grade": "A", "comment": "전략적 사고 능력이 양호하며, 장기적 관점에서 접근할 수 있음."},
                    {"evaluate_type": "조직 적응력", "evaluate_score": 92.0, "grade": "A+", "comment": "조직 적응력이 매우 우수하며, 새로운 환경에 빠르게 적응하고 기여함."},
                    {"evaluate_type": "비전 제시", "evaluate_score": 90.0, "grade": "A+", "comment": "비전 제시 능력이 뛰어나며, 팀원들의 공감을 얻을 수 있는 능력이 있음."},
                    {"evaluate_type": "의사결정 능력", "evaluate_score": 85.0, "grade": "A", "comment": "의사결정 능력이 우수하며, 신속하고 정확한 판단을 할 수 있음."},
                    {"evaluate_type": "인성 및 가치관", "evaluate_score": 86.0, "grade": "A", "comment": "올바른 가치관을 보유하고 있으며, 신뢰할 수 있는 인성을 보유함."}
                ]
            }
        ]
    }
