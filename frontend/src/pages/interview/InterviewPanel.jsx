    ...
    const checkEvaluationStatus = async () => {
      ...
      try {
        ...
        const applicationData = await getApplication(applicationId);
          ...
          console.log('현재 면접 상태:', { aiInterviewStatus, practicalInterviewStatus, executiveInterviewStatus });
            ...
            <div className="pt-4 border-t border-gray-200">
              <button
                  ...
                  const evaluationData = {
                        ...
                        resume_id: resumeId,
                        interview_type: interviewType, // 동적으로 설정
                        interview_stage: interviewStage, // 동적으로 설정
