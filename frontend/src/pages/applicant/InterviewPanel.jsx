                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex items-center">
                      ...
                      <span className="ml-2">{resumeInfo.name || applicantName}</span>
                    </div>
                    <div className="flex items-center">
                      <FaPhone className="w-4 h-4 mr-2 text-gray-500" />
                      <span className="font-medium">연락처:</span>
                      <span className="ml-2">{resumeInfo.phone || 'N/A'}</span>
                    </div>
                    <div className="flex items-center">
                      <FaEnvelope className="w-4 h-4 mr-2 text-gray-500" />
                      <span className="font-medium">이메일:</span>
                      <span className="ml-2">{resumeInfo.email || 'N/A'}</span>
                    </div>
                    <div className="flex items-center">
                      <FaMapMarkerAlt className="w-4 h-4 mr-2 text-gray-500" />
                      <span className="font-medium">주소:</span>
                      <span className="ml-2">{resumeInfo.address || 'N/A'}</span>
                    </div>
                  </div>
                </div>
