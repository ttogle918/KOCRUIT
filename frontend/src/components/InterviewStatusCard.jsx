...
const InterviewStatusCard = ({ applicant, onStatusChange }) => {
  ...
  const [currentFirstStatus, setCurrentFirstStatus] = useState(applicant?.first_interview_status || 'PENDING');
  const [currentSecondStatus, setCurrentSecondStatus] = useState(applicant?.second_interview_status || 'PENDING');
  ...
  const handleStatusUpdate = async (stage, newStatus) => {
    ...
    try {
      ...
      if (stage === 'ai') {
        ...
        updateData.first_interview_status = newStatus;
        setCurrentFirstStatus(newStatus);
      } else if (stage === 'second') {
        updateData.second_interview_status = newStatus;
